...
from simulations.pdie import PDIES, PDIE
...
if __name__ == '__main__':
    ...
    atom_PDIE_1 = PDIE(is_atom=True,
                       meta_PDIES=empty_PDIES,
                       DI_2tuple_S=DI_2tuple_S_1)
    ...
    atom_PDIE_2 = PDIE(is_atom=True,
                       meta_PDIES=empty_PDIES,
                       DI_2tuple_S=DI_2tuple_S_2)
