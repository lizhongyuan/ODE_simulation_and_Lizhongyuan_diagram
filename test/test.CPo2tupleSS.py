from simulations.function import fMin1oS, fMax2oS, _fCPo2tupleSSRecur
from simulations.function import fCPo2tupleSS
...
if __name__ == '__main__':
    ...
    # 2tupleSS做某个顺序的笛卡尔积
    twoTupleTS_CP = fCPo2tupleSS(twoTupleSS, idxT)
